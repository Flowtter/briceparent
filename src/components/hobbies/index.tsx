...
function Gaming() {
	...
	const description = t(
		'I\'ve been playing Overwatch for over four years, I reached the highest rank there, the "Top 500 Europeans". I had the opportunity to play for a year on a team with regular training.'
	);
	return (
...
function Coding() {
	...
	const description = t(
		'I discovered programming in early 2018 with python. Then I continued with Unity and after 2 years, I moved to Golang and react.'
	);
	return (
		<div className={`${styles.hobby} mac`}>
			...
			<div className={styles.textContainer}>
				...
				<p className={styles.line1}>
					{t('$ cat hello.txt')}
					<span className={styles.cursor1}>_</span>
				</p>
				...
				<p className={styles.line3}>
					{t("I'm Brice!")}
					<span className={styles.cursor3}>_</span>
				</p>
			</div>
			<div className={styles.text}>
				<h1 className={styles.title}>{title}</h1>
...
function Printing() {
	...
	const description = t(
		'3D printing is a hobby that I have enjoyed doing for a few years now. I have bought one in 2018, since then I print mechanical parts from time to time.'
	);
	return (
		<div className={styles.hobby}>
			<h1 className={styles.subtitle}>{title}</h1>
	...
	>
		<g id="printer 1" clipPath="url(#clip0)">
			...
			<g id="body">
				<path
					id="Vector_3"
					d="M479 452H69V512H479V452Z"
					fill="#282828"
				/>
				<path id="Vector_4" d="M84 57H69V437H84V57Z" fill="#CDCCCC" />
				<path
					id="Vector_5"
					d="M464 437H84V452H464V437Z"
					fill="#CDCCCC"
				/>
				<path id="Vector_6" d="M84 437H69V452H84V437Z" fill="#323232" />
				<path
					id="Vector_7"
					d="M479 437H464V452H479V437Z"
					fill="#323232"
				/>
				<path
					id="Vector_8"
					d="M479 57H464V437H479V57Z"
					fill="#CDCCCC"
				/>
			...
			<g id="corner">
				<g id="Group">
					<path
						id="Vector_12"
						d="M89 387H84V437H89V387Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_13"
						d="M134 432H84V437H134V432Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_14"
						d="M89.2083 390.924L84.4347 395.697L125.612 436.875L130.386 432.101L89.2083 390.924Z"
						fill="#5C5C5C"
					/>
				</g>
				<g id="Group_2">
					<path
						id="Vector_15"
						d="M464 432H414V437H464V432Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_16"
						d="M464 387H459V437H464V387Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_17"
						d="M417.966 431.801L422.739 436.576L463.922 395.404L459.149 390.63L417.966 431.801Z"
						fill="#5C5C5C"
					/>
				</g>
				<g id="Group_3">
					<path
						id="Vector_18"
						d="M134 57H84V62H134V57Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_19"
						d="M89 57H84V107H89V57Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_20"
						d="M130.052 62.2035L125.279 57.4292L84.0962 98.6006L88.8691 103.375L130.052 62.2035Z"
						fill="#5C5C5C"
					/>
				</g>
				<g id="Group_4">
					<path
						id="Vector_21"
						d="M464 57H459V107H464V57Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_22"
						d="M464 57H414V62H464V57Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_23"
						d="M458.79 103.041L463.564 98.2678L422.393 57.0847L417.618 61.8577L458.79 103.041Z"
						fill="#5C5C5C"
					/>
				</g>
			</g>
			<g id="bed">
				<path
					id="Vector_24"
					d="M394 393H155V401H394V393Z"
					fill="#1081B0"
				/>
				<path
					id="Vector_25"
					d="M211 401H196V407H211V401Z"
					fill="#8D8E8C"
				/>
				<path
					id="Vector_26"
					d="M352 401H337V407H352V401Z"
					fill="#8D8E8C"
				/>
				<path
					id="Vector_27"
					d="M372 407H175V460H372V407Z"
					fill="#5C5C5C"
				/>
			</g>
			<g id="z-axis">
				<path
					id="Vector_28"
					d="M464.213 328H88.213V339H464.213V328Z"
					fill="#CDCCCC"
				/>
				<path
					id="Vector_29"
					d="M454.213 350H119.213V359H454.213V350Z"
					fill="#8D8E8C"
				/>
				<path
					id="Vector_30"
					d="M454.213 376H119.213V385H454.213V376Z"
					fill="#8D8E8C"
				/>
				<path
					id="Vector_31"
					d="M477.213 340H454.213V395H477.213V340Z"
					fill="#323232"
				/>
				<path
					id="Vector_32"
					d="M119.213 340H75.213V395H119.213V340Z"
					fill="#323232"
				/>
				<path
					id="Vector_33"
					d="M88.213 406C88.213 408.762 86.791 411 84.486 411H73.636C71.332 411 69.213 408.762 69.213 406V396C69.213 393.239 71.332 391 73.636 391H84.487C86.792 391 88.214 393.239 88.214 396V406H88.213Z"
					fill="#323232"
				/>
				<path
					id="Vector_34"
					d="M88.213 340C88.213 342.761 86.791 345 84.486 345H73.636C71.332 345 69.213 342.761 69.213 340V330C69.213 327.239 71.332 325 73.636 325H84.487C86.792 325 88.214 327.239 88.214 330V340H88.213Z"
					fill="#323232"
				/>
				<path
					id="Vector_35"
					d="M464.213 406C464.213 408.762 465.635 411 467.94 411H478.791C481.095 411 483.214 408.762 483.214 406V396C483.214 393.239 481.095 391 478.791 391H467.94C465.635 391 464.213 393.239 464.213 396V406Z"
					fill="#323232"
				/>
				<path
					id="Vector_36"
					d="M464.213 340C464.213 342.761 465.635 345 467.94 345H478.791C481.095 345 483.214 342.761 483.214 340V330C483.214 327.239 481.095 325 478.791 325H467.94C465.635 325 464.213 327.239 464.213 330V340Z"
					fill="#323232"
				/>
				<path
					id="Vector_37"
					d="M71.213 345H26.213V390H71.213V345Z"
					fill="#5C5C5C"
				/>
				<path
					id="Vector_38"
					d="M71.213 345H26L71.213 334.5V345Z"
					fill="#323232"
				/>
				<path
					id="Vector_39"
					d="M71.213 390H26L71.213 400.5V390Z"
					fill="#323232"
				/>
				<g xmlns="http://www.w3.org/2000/svg" id="y-axis">
					<path
						id="Vector_40"
						d="M285.046 300H273.213L275.413 296H282.998L285.046 300Z"
						fill="#8D8E8C"
					/>
					<path
						id="Vector_41"
						d="M271.046 300H259.213L261.413 296H268.998L271.046 300Z"
						fill="#8D8E8C"
					/>
					<path
						id="Vector_42"
						d="M294 300C294 212.668 555.175 142 875 142"
						stroke="#1E1E1E"
						strokeWidth="4"
					/>
					<path
						id="Vector_43"
						d="M265 300C265 190.559 550.802 102 904 102"
						stroke="#4A4C4E"
						strokeWidth="3"
					/>
					<path
						id="Vector_44"
						d="M279 300C279 182.268 548.253 87 881 87"
						stroke="#FA9C1D"
						strokeWidth="3"
					/>
					<path
						id="Vector_45"
						d="M308.213 345H249.213V391H308.213V345Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_46"
						d="M308.213 345H249.213V348H308.213V345Z"
						fill="#B3B3B3"
					/>
					<path
						id="Vector_47"
						d="M301.213 300H256.213V345H301.213V300Z"
						fill="#5C5C5C"
					/>
					<path
						id="Vector_48"
						d="M287.213 348H271.213V380H287.213V348Z"
						fill="#323232"
					/>
					<path
						id="Vector_49"
						d="M285.901 382H272.776L271.213 380H287.213L285.901 382Z"
						fill="#323232"
					/>
					<path
						id="Vector_50"
						d="M287.213 382H271.213V390H287.213V382Z"
						fill="#1081B0"
					/>
					<path
						id="Vector_51"
						d="M274.205 390L279.119 392.938L284.033 390H274.205Z"
						fill="#1081B0"
					/>
					<path
						id="Vector_52"
						d="M272.213 354H270.213V355H272.213V354Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_53"
						d="M272.213 357H270.213V358H272.213V357Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_54"
						d="M272.213 360H270.213V361H272.213V360Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_55"
						d="M272.213 363H270.213V364H272.213V363Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_56"
						d="M272.213 366H270.213V367H272.213V366Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_57"
						d="M288.213 354H286.213V355H288.213V354Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_58"
						d="M288.213 357H286.213V358H288.213V357Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_59"
						d="M288.213 360H286.213V361H288.213V360Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_60"
						d="M288.213 363H286.213V364H288.213V363Z"
						fill="#CDCCCC"
					/>
					<path
						id="Vector_61"
						d="M288.213 366H286.213V367H288.213V366Z"
						fill="#CDCCCC"
					/>
				</g>
			</g>
	...
	>
		<g>
			<g>
				<path
					fill="#DA768E"
					d="M252.583,132.75h-9.619c-7.484-19.855-23.73-36.474-44.965-46.71V58.5
