...
const cross = (
	<svg viewBox="0 0 83 92" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path
			d="M75.5 2C64.7 5.2 29 58.6667 13 84.5C13 84.5 8 94 15 90L43.5 52L50.5 43L77.5 9.5C81.3334 5.66667 86.3 -1.2 75.5 2Z"
			fill="#ecf0bf"
			stroke="#ecf0bf"
		/>
		<path
			d="M73.3004 81.9319C63.0752 70.6719 24.3063 41.2214 2.8004 21.9319C0.685859 18.7112 0.129917 18.0525 2.8004 18C60.9678 43.4209 29.6089 36.4691 74.3004 75.9319C86.8004 87.9319 73.3004 81.9319 73.3004 81.9319Z"
			fill="#ecf0bf"
			stroke="#ecf0bf"
		/>
	</svg>
